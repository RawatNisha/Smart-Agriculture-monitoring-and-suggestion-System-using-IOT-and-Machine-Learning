            ...
            <footer>
                <div className="footerOptions">
                    <div className="smallIntro">
                        <h1>Smart Farming</h1>
                        <p>Web site created for use of Smart farming in day to day life.
                        </p>
                        <div className="links">
                            <a href="https://github.com/RawatNisha/Smart-Agriculture-monitoring-and-suggestion-System-using-IOT-and-Machine-Learning"><GitHubIcon /></a>
                        </div>
                    </div>
                    ...
                    <div className="option contactDetails">
                        ...
                        <li><a href="mailto:info.kisaan@gmail.com">Email: <span>info.kisaan@gmail.com</span></a></li>
